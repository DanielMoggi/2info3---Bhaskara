...
def explode_string(s):
    ...
    """
    if len(s) == 1: return s
    elif len(s) == 2: return s[:1]+s
    elif len(s) == 3: return s[:1]+s[:2]+s
    elif len(s) == 4: return s[:1]+s[:2]+s[:3]+s
    elif len(s) == 5: return s[:1]+s[:2]+s[:3]+s[:4]+s
    else: return s[:1]+s[:2]+s[:3]+s[:4]+s[:5]+s
